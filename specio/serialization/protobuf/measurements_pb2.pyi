...
class Colorimeter_Measurement(_message.Message):
    ...
    exposure: float
    colorimeter_id: str
    def __init__(self, XYZ: _Optional[_Union[XYZ_value, _Mapping]] = ..., xy: _Optional[_Union[xy_value, _Mapping]] = ..., cct: _Optional[_Union[cct_value, _Mapping]] = ..., dominant_wl: _Optional[float] = ..., time: _Optional[_Union[Timestamp, _Mapping]] = ..., exposure: _Optional[float] = ..., colorimeter_id: _Optional[str] = ...) -> None: ...
...
class Measurement_List(_message.Message):
    __slots__ = ("spd_measurements", "xyz_measurements", "test_colors", "order", "notes", "author", "location", "software", "ancillary")
    ...
    XYZ_MEASUREMENTS_FIELD_NUMBER: _ClassVar[int]
    ...
    xyz_measurements: _containers.RepeatedCompositeFieldContainer[Colorimeter_Measurement]
    ...
    software: str
    ancillary: bytes
    def __init__(self, spd_measurements: _Optional[_Iterable[_Union[SPD_Measurement, _Mapping]]] = ..., xyz_measurements: _Optional[_Iterable[_Union[Colorimeter_Measurement, _Mapping]]] = ..., test_colors: _Optional[_Iterable[_Union[Measurement_List.TestColor, _Mapping]]] = ..., order: _Optional[_Iterable[int]] = ..., notes: _Optional[str] = ..., author: _Optional[str] = ..., location: _Optional[str] = ..., software: _Optional[str] = ..., ancillary: _Optional[bytes] = ...) -> None: ...
